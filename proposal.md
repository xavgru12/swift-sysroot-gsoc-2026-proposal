...
- **Week 4:** Prepare for the introduction of new build products.  
- **Week 5:** Implement ` LinuxSwiftSDK` as a subclass of ` SwiftSDK` and configure the necessary CMake options.  
